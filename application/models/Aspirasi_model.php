...
class Aspirasi_model extends MY_Model {
	...
	public $table = 'aspirasi'; // you MUST mention the table name
    public $primary_key = 'ASPIRASI_ID'; // you MUST mention the primary key
    public $fillable = array('USER_ID', 'ASPIRASI'); // If you want, you can set an array with the fields that can be filled by insert/update
