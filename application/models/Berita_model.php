...
class Berita_model extends MY_Model {
    ...
    public $fillable = array('USER_ID', 'NEWS', 'PARENT_ID', 'CATEGORY_ID', 'HEADER', 'SUB_HEADER'); // If you want, you can set an array with the fields that can be filled by insert/update
