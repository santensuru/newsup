...
class Berita_model extends MY_Model {
    ...
    public $primary_key = 'NEWS_ID'; // you MUST mention the primary key
    public $fillable = array('USER_ID', 'NEWS', 'PARENT_ID', 'CATEGORY_ID', 'HEADER', 'SUB_HEADER', 'IMAGE', 'PERMISSION', 'IS_NEWS'); // If you want, you can set an array with the fields that can be filled by insert/update
