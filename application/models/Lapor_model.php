...
class Lapor_model extends MY_Model {
	...
	public $table = 'lapor'; // you MUST mention the table name
    public $primary_key = 'LAPOR_ID'; // you MUST mention the primary key
    public $fillable = array('PIHAK', 'NOMOR'); // If you want, you can set an array with the fields that can be filled by insert/update
