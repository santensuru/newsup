...
class Profile_model extends MY_Model {
	...
	public $table = 'profile'; // you MUST mention the table name
    public $primary_key = 'PROFILE_ID'; // you MUST mention the primary key
    public $fillable = array('USER_ID', 'NAME', 'STATUS'); // If you want, you can set an array with the fields that can be filled by insert/update
