...
class Respond_model extends MY_Model {

	public $table = 'respond'; // you MUST mention the table name
    public $primary_key = 'RESPOND_ID'; // you MUST mention the primary key
    public $fillable = array('RESPOND', 'QUESTION_ID', 'USER_ID'); // If you want, you can set an array with the fields that can be filled by insert/update
