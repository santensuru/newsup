        ...
        $('.comment').click(function(){
            ...
            $.ajax({
                ...
                success : function(result)
                {
                    ...
                    html += "<br>";
                    html += `<?php echo form_open('kolaborasi/command'); ?>`;
                    html += `<input type="hidden" name="news_id" value="<?=$berita[0]['NEWS_ID']?>" />`;
                    html += `<input type="hidden" name="parent_id" value="<?=$berita[0]['NEWS_ID']?>" />`;
